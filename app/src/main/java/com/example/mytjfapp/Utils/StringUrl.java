...
public class StringUrl {
    ...
    public static String getMeiziUrl = "http://gank.io/api/data/福利/10/";
    public static String getVideo = "http://gank.io/api/data/休息视频/5/";
    public static String getAndroid = "http://gank.io/api/data/Android/10/";
