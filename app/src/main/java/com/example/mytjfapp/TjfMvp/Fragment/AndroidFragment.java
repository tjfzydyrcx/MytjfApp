...
public class AndroidFragment extends BaseMvPFragmemt<TextPresenterImpl, TextModelImpl> implements TextContract.TextsView {
    ...
    protected void loadData() {
        LogUtils.e("zhoule==" + "loaddata");
        String value = StringUrl.getAndroid + i;
    ...
    public void setData(List<AllBean.ResultsBean> beanList) {
        LogUtils.e("beanList=" + beanList.size());
